...
import UniversalExtractPage from './pages/operations/UniversalExtractPage'
...
export default function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/op/universal-extract" element={profile ? <UniversalExtractPage profile={profile} /> : <Navigate to="/login" />} />
